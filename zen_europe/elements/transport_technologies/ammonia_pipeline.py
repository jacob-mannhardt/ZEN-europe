...
class AmmoniaPipeline(TransportTechnology):
    """Class containing all data and assumptions for ammonia pipeline
    transport technology."""

    name: str = "ammonia_pipeline"
    ...
    def _set_reference_carrier(self) -> Attribute:
        """
        Sets the reference carrier of ammonia pipeline to ammonia.
        """
        return Attribute(
    ...
    def _set_lifetime(self) -> Attribute:
        """
        Sets the lifetime of ammonia pipeline.
        """
        ammonia_pipelines = AmmoniaPipelinesGalimova(source_path=self.source_path)
        return ammonia_pipelines.get_lifetime(self)

    def _set_construction_time(self) -> Attribute:
        """
        Sets the construction time of ammonia pipeline.
        """
    ...
    def _set_transport_loss_factor_linear(self) -> Attribute:
        """
        Sets the linear transport loss factor of ammonia pipeline.
        """
        ammonia_pipelines = AmmoniaPipelinesGalimova(source_path=self.source_path)
        return ammonia_pipelines.get_transport_loss_factor_linear(self)

    def _set_capex_per_distance_transport(self) -> Attribute:
        """
        Sets the distance-specific capex of ammonia pipeline.
        """
    ...
    #     """
    #     Sets the distance-specific fixed opex of ammonia pipeline.
    #     """
    #     transport_costs = TransportTechnologiesCosts(
    #         settings=self.settings,
    #         source_path=self.source_path,
    ...
    def _set_capacity_limit(self) -> Attribute:
        """
        Sets the capacity limit of ammonia pipeline.

...
class ICE_petrol(ConversionTechnology):
    """Class containing all data and assumptions for petrol internal
    ...
    def _set_reference_carrier(self) -> Attribute:
        """
        Sets the reference carrier of ICE petrol to passenger mileage.
        """
        return Attribute(
    ...
    def _set_input_carrier(self) -> Attribute:
        """
        Sets the input carrier of ICE petrol to gasoline.
        """
        return Attribute(
            name="input_carrier", default_value=["gasoline"], element=self)

    def _set_output_carrier(self) -> Attribute:
        """
        Set the output carrier of ICE petrol to passenger mileage.
        """
        return Attribute(
    ...
    def _set_max_diffusion_rate(self) -> Attribute:
        """
        Sets the maximum diffusion rate of ICE petrol.
        """

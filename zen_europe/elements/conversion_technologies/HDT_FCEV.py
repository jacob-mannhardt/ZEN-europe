...
class HDT_FCEV(ConversionTechnology):
    ...
    def _set_opex_specific_variable(self) -> Attribute:
        """
        Sets the specific variable OPEX of HDT FCEV.
    ...
    def _set_capex_specific_conversion(self) -> Attribute:
        """
        Sets the specific conversion CAPEX of HDT FCEV.
    ...
    def _set_capacity_existing(self) -> Attribute:
        """
        Sets the existing capacity of HDT FCEV.
        ...
        if self.settings.investment.use_existing_capacities:
            ...
            return attr.set_data(
                ...
                source=SourceInformation(
                    description=(
                        "The existing capacity of HDT FCEV is calculated from the "
                        "existing fleet of HDT FCEV vehicles and the total truck "
    ...
    def _set_max_load(self) -> Attribute:
        """
        Sets the maximum load of HDT FCEV.
    ...
    def _set_max_diffusion_rate(self) -> Attribute:
        """
        Sets the maximum diffusion rate of HDT FCEV.
        """

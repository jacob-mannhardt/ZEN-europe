...
class ElectrodeBoilerDH(ConversionTechnology):
    """Class containing all data and assumptions for district heating electrode boilers."""

    name: str = "electrode_boiler_DH"
    ...
    def _set_reference_carrier(self) -> Attribute:
        """
        Sets the reference carrier of district heating electrode boilers to district_heat.
        """
        return Attribute(
    ...
    def _set_input_carrier(self) -> Attribute:
        """
        Sets the input carrier of district heating electrode boilers to electricity.
        """
        return Attribute(
    ...
    def _set_output_carrier(self) -> Attribute:
        """
        Set the output carrier of district heating electrode boilers to district_heat.
        """
        return Attribute(
    ...
    def _set_lifetime(self) -> Attribute:
        """
        Sets the lifetime of district heating electrode boilers.
    ...
    def _set_conversion_factor(self) -> Attribute:
        """
        Return the conversion factor of district heating electrode boilers.
        ...
        source = SourceInformation(
            description=(
                f"The conversion factor of district heating electrode boilers is based on data from {', '.join(agencies)}. "
            ),
    ...
    def _set_construction_time(self) -> Attribute:
        """
        Sets the construction time of district heating electrode boilers.
        ...
        if self.settings.investment.use_construction_times:
            ...
            source = AssumptionInformation(
                description=(
                    "The construction time of DH electrode boilers is assumed to be 0 years, "
    ...
    def _set_capex_specific_conversion(self) -> Attribute:
        """
        Sets the specific capital expenditure (capex) for district heating electrode boilers.
    ...
    def _set_opex_specific_fixed(self) -> Attribute:
        """
        Sets the specific fixed operational expenditure (opex) for district heating electrode boilers.
    ...
    def _set_opex_specific_variable(self) -> Attribute:
        """
        Sets the specific variable operational expenditure (opex) for district heating electrode boilers.
    ...
    def _set_capacity_existing(self) -> Attribute:
        """
        Sets the existing capacity for district heating electrode boilers.
    ...
    def _set_max_diffusion_rate(self) -> Attribute:
        """
        Sets the maximum diffusion rate of electrode boiler DH.
        """

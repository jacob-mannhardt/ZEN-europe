...
class AmmoniaICEShip(ConversionTechnology):
    """Class containing all data and assumptions for ammonia internal
    combustion engine ships."""

    name: str = "ammonia_ICE_ship"
    ...
    def _set_reference_carrier(self) -> Attribute:
        """
        Sets the reference carrier of ammonia ICE ships to shipping.
        """
        return Attribute(
    ...
    def _set_input_carrier(self) -> Attribute:
        """
        Sets the input carrier of ammonia ICE ships to ammonia.
        """
        return Attribute(
            name="input_carrier", default_value=["ammonia"], element=self)

    def _set_output_carrier(self) -> Attribute:
        """
        Set the output carrier of ammonia ICE ships to shipping.
        """
        return Attribute(
    ...
    def _set_lifetime(self) -> Attribute:
        """
        Sets the lifetime of ammonia ICE ships.
    ...
    def _set_conversion_factor(self) -> Attribute:
        """
        Return the conversion factor of ammonia ICE ships.
        ...
        source = SourceInformation(
            description=(
                "The conversion factor of ammonia ICE ships is obtained "
    ...
    def _set_opex_specific_variable(self) -> Attribute:
        ...
        korberg_dataset = ShippingTechnologiesKorberg(source_path=self.source_path)
        cf_dict = korberg_dataset.get_shipping_conversion_factors(self)
        fuel_per_service = cf_dict["ammonia"]
        ...
        attr.set_data(
            ...
            source=SourceInformation(
                description=(
                    "The variable opex of ammonia ICE ships is manually "
    ...
    def _set_max_load(self) -> Attribute:
        """
        Sets the maximum load for ammonia ICE ships.
    ...
    def _set_capex_specific_conversion(self) -> Attribute:
        """
        Sets the specific capital expenditure (capex) for ammonia ICE ships.
        ...
        attr.set_data(
            ...
            source=SourceInformation(
                description=(
                    "The specific capex of ammonia ICE ships is obtained "
    ...
    def _set_opex_specific_fixed(self) -> Attribute:
        """
        Sets the specific fixed operational expenditure (opex) for ammonia ICE ships.
        ...
        attr.set_data(
            ...
            source=SourceInformation(
                description=(
                    "The specific fixed opex of ammonia ICE ships is obtained "
                    "from Korberg et al. (2021)."
                ),
                metadata=korberg_dataset.metadata,
            ),
    ...
    def _set_max_diffusion_rate(self) -> Attribute:
        """
        Sets the maximum diffusion rate of ammonia ICE ship.
        """

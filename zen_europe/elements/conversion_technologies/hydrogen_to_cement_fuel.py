...
class HydrogenToCementFuel(ConversionTechnology):
    ...
    def _set_conversion_factor(self) -> Attribute:
        ...
        attr.set_data(
            ...
            source=AssumptionInformation(
                description=(
                    "The conversion factor of hydrogen to cement fuel is "
    ...
    def _set_capex_specific_conversion(self) -> Attribute:
        ...
        Based on ECRA (2022), Technology Paper 16,
        ...
        capex = _get_capex_cement_fuel_retrofit(additional_cost=4.5 * 1e6)
        attr.set_data(
            default_value=capex,
            unit="Euro/GW",
            source=AssumptionInformation(
                description=(
                    "The specific capex of hydrogen to cement fuel is "
                    ...
                    "additional 4.5 M EUR retrofitting cost for hydrogen "
                    "firing (assuming the upper end of the cost range, to "
                    "account for the fuel-substitution limit), based on "
                    "https://ecra-online.org/fileadmin/redaktion/files/pdf/"
                    "ECRA_Technology_Papers_2022.pdf, Technology Paper 16."
                ),
            ),
        )
        return attr
    ...
    # hydrogen-fired cement-fuel capacity within total clinker demand
    # (`_existing_capacity_cement_fuel` in the legacy pipeline, using a 0%
    # existing hydrogen share from AIDRES); no clean equivalent hook is

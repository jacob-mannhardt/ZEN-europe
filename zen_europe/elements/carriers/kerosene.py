...
class Kerosene(Carrier):
    """Kerosene carrier class.

    This class implements the specific behavior for the kerosene carrier.
    """
    ...
    def _set_availability_import(self) -> Attribute:
        """
        Return the import availability of kerosene.
